...
export default function SignIn({ providers }: SignInProps) {
  return (
    <>
      <Head>
        <title>Connexion - EchoChat Admin</title>
      </Head>
          ...
          <div className="mt-8 space-y-4">
            {providers && Object.values(providers).map((provider) => (
              <button
                ...
                className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-gray-300 rounded-lg shadow-sm bg-white hover:bg-gray-50 transition"
              >
                {provider.id === 'google' && (
